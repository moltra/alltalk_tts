...
def main():
    ...
    cert_name = input("Certificate name (default: test_cert): ") or "test_cert"
    cn = input("Common Name (default: localhost): ") or "localhost"
    days = input("Valid days (default: 365): ") or "365"
