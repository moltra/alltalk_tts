...
def train_tokenizer(
    input_path, tokenizer_path, language, special_tokens=["[STOP]", "[UNK]", "[SPACE]"], vocab_size=256
):
...
if __name__ == "__main__":
    ...
    tokenizer_path = (
        "/alltalk_tts/expanded_models/tortoise_tokenizer2xttsv2.json"  # define path to put the newly create vocab.json
    )
