...
def download_language_pack(lang_code, progress=gr.Progress()):
    ...
    for idx, model in enumerate(models, 1):
        ...
        try:
            ...
            errors.append(f"Error downloading {model['model_name']}: {e!s}")
...
def vits_model_update_settings(
    ...
    print(f"[DEBUG] VITS Settings saved - File: {settings_file}")
    print(f"[DEBUG] VITS Settings saved - Data: {json.dumps(model_config_data, indent=2)[:500]}...")
    ...
    with gr.Blocks(title="vits TTS", analytics_enabled=False) as app:
        ...
        with gr.Tab("Models/Voices Download"):
            ...
            cancel_button.click(
                ...
                None,
                [confirm_button, download_button, cancel_button],
            )
