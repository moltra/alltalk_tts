...
def xtts_model_update_settings(
    ...
    print(f"[DEBUG] Template Engine Settings saved - File: {settings_file}")
    print(f"[DEBUG] Template Engine Settings saved - Data: {json.dumps(model_config_data, indent=2)[:500]}...")
        ...
        with gr.Tab("Models/Voices Download"):
            ...
            def show_confirm_cancel(model_name):
                all_files_exists = all(
                    os.path.exists(os.path.join(main_dir, "models", "xtts", model["folder_path"], file))
